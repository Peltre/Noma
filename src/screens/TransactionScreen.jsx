...
export default function TransactionScreen() {
    ...
    return (
        // Toda la pantalla toma el acento del tipo de movimiento: bordes
        // al enfocar, pastillas seleccionadas, botón, asteriscos. Antes
        // salían en turquesa aunque se estuviera registrando un gasto,
                                ...
                                return (
                                    <TouchableOpacity
                                        ...
                                        style={[
                                            styles.iconOption,
                                            isSelected
                                                ? { backgroundColor: cur.color + '29', borderColor: cur.color }
                                    ...
                                    >
                                        <OptIcon color={isSelected ? cur.color : theme.muted} size={16} />
                                    </TouchableOpacity>
                                );
                            })}
                        </View>
